...
def construct_vae_dataset(df_path, train_ratio, split_test=False, test_test_ratio=0.5, seed=1234):
    ...
    if split_test:
        ...
        im1 = im[train_user_index]
        im2 = im[test_user_index]
        ...
        return train_matrix.toarray(), test_matrix.toarray(), train_user_index, test_user_index, im1, im2
