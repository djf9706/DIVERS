...
def parse_args():
    ...
    parser.add_argument("--sim_suffix", type=str, default="_sr_0.1_cr_2.0_nr_10.0_tr_0.0")
    ...
    if args.dataset == "yahoo":
        ...
        data_params["train_path"] = dir_prefix + "/data_process/simiv/train{}.csv".format(args.sim_suffix)
